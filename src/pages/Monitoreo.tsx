...
import { ArrowLeft, Shield, Clock, AlertTriangle, Phone, Mail, MessageCircle } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      description: "Información sobre nuestro servicio de monitoreo profesional",
      articles: [
        {
    ...
    },
    {
      ...
      description: "Cómo actuamos ante una emergencia",
      articles: [
        {
          title: "Protocolo de emergencias",
        ...
        },
        {
          ...
          url: "/articulo/tiempos-respuesta"
        },
        {
          title: "Coordinación con autoridades",
          url: "/articulo/coordinacion-autoridades"
        }
      ]
    },
    {
      id: 3,
      title: "Reportes y Comunicaciones",
      icon: <Clock className="h-6 w-6 text-primary" />,
      description: "Información sobre reportes y comunicaciones",
      articles: [
        {
        ...
        },
        {
          ...
          url: "/articulo/notificaciones-automaticas"
        },
        {
          title: "Reportes mensuales",
          url: "/articulo/reportes-mensuales"
        }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">Central de Monitoreo</h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Información completa sobre nuestro servicio de monitoreo profesional 24/7
          </p>
        </div>
